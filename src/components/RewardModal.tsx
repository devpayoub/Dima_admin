...
export const RewardModal: React.FC<RewardModalProps> = ({ isOpen, onClose, loading, reward: _reward, rewardName, businessName, showCloseButton = true, scope = 'fullscreen', colors }) => {
