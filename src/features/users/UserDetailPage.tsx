...
import { CampaignQrDialog } from '@/features/campaigns/CampaignQrDialog';
...
export default function UserDetailPage() {
  ...
  const licenseKeyCols = [
    ...
    { header: 'Activated', accessor: (row: AdminLicenseKey) => row.activated_at ? new Date(row.activated_at).toLocaleDateString() : 'â€”' },
    { header: 'Expires', accessor: (row: AdminLicenseKey) => row.expires_at ? new Date(row.expires_at).toLocaleDateString() : 'â€”' },
